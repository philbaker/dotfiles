...
local function _1_(_, opts)
  ...
  return treesitter.setup({highlight = {enable = true}, matchup = {enable = true, disable = {"javascript"}}, indent = {enable = true}, ensure_installed = {"html", "css", "javascript", "typescript", "clojure", "lua", "php", "regex", "yaml", "svelte", "fennel", "markdown", "python", "java", "vue", "c", "vim", "vimdoc"}})
end
