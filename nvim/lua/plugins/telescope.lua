...
local function _2_()
  ...
  telescope.setup({defaults = {mappings = {i = {["<c-l>"] = (actions.send_to_qflist + actions.open_qflist), ["<c-r>"] = actions.close, ["<c-n>"] = actions.cycle_history_next, ["<c-p>"] = actions.cycle_history_prev, ["<c-t>"] = layout.toggle_preview, ["<c-i>"] = lga_actions.quote_prompt({postfix = " --glob"})}}}, pickers = {find_files = {find_command = {"rg", "--files", "--hidden", "--no-ignore", "--glob", "!**/.git/*", "--glob", "!**/.clj-kondo", "--glob", "!**/.clerk", "--glob", "!**/.lsp", "--glob", "!**/.cpcache", "--glob", "!**/node_modules/*", "--glob", "!vendor/*"}}, git_files = {show_untracked = true}}})
