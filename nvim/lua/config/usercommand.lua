...
local function _54_()
  local items = {"Biff", "CSS", "Clojure", "ClojureScript", "DSA", "Database design", "Dumdom/Portfolio", "Fennel", "FP", "HTTP", "Integrant", "JavaScript", "Keyboard", "Linux CLI", "Malli", "React", "REST", "Regex/Regal", "Ring", "SQL/Next/Honey", "Squint", "Vim"}
