...
util["set-uc"]("Ftd", _30_)
local function _31_()
  return vim.fn.setreg("+", vim.fn.expand("%:~:."))
end
util["set-uc"]("YankFilePath", _31_)
return {}
