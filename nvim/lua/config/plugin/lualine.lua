local _2afile_2a = "/home/pb/.config/nvim/fnl/config/plugin/lualine.fnl"
...
local core, lualine = autoload("aniseed.core"), autoload("lualine")
...
lualine.setup({options = {theme = github_lua_theme, icons_enabled = true, section_separators = {"", ""}, component_separators = {"\239\145\138", "\239\144\184"}}, sections = {lualine_a = {}, lualine_b = {{"mode", {upper = true}}}, lualine_c = {{"FugitiveHead"}, {"orgmode.statusline()"}, {"tostring(string.gsub(vim.fn.getcwd(), os.getenv('HOME'), ''))"}, {"filename", {filestatus = true, path = 1}}}, lualine_x = {{"diagnostics", {sections = {"error", "warn", "info", "hint"}, sources = {"nvim_lsp"}}}, {lsp_connection}, "location", "filetype"}, lualine_y = {"encoding"}, lualine_z = {}}, inactive_sections = {lualine_a = {}, lualine_b = {}, lualine_c = {{"filename", {filestatus = true, path = 1}}}, lualine_x = {}, lualine_y = {}, lualine_z = {}}})
return _2amodule_2a