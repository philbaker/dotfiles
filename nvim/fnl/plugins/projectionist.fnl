[{1 :tpope/vim-projectionist
  :config (fn []
            (set vim.g.projectionist_heuristics
                 {:app/&composer.json {:app/*.php {:alternate ["tests/{}Test.php"]
                                                   :type :source}
                                       :tests/*Test.php {:alternate "app/{}.php"
                                                         :type :test}}
                  :artisan {:* {:console "php artisan tinker"
                            ...
                            :tests/Feature/*Test.php {:alternate "app/{}.php"
                                                      :type :test}
                            :tests/Unit/*Test.php {:alternate "app/{}.php"
                                                   :type :test}}
                  :src/&composer.json {:src/*.php {:alternate ["tests/{}Test.php"]
                                                   :type :source}
                                       :tests/*Test.php {:alternate "src/{}.php"
                                                         :type :test}}}))
