...
(nvim.set_keymap :n :<leader>pp "<C-W><C-J><C-W><C-L>" {:noremap true})
(nvim.set_keymap :n :<leader>pk "<C-W><C-K><Plug>(zoom-toggle)" {:noremap true})
(nvim.set_keymap :n :<leader>ph "<C-W><C-J><C-W><C-H><Plug>(zoom-toggle)" {:noremap true})
(nvim.set_keymap :n :<leader>pl "<C-W><C-J><C-W><C-L><Plug>(zoom-toggle)" {:noremap true})
